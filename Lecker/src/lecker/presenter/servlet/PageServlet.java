...
public class PageServlet extends AbstractServlet {
	...
	public synchronized void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Boolean isMobile = userAgent.contains("Chrome") || userAgent.contains("iPhone") || userAgent.contains("iPad") || userAgent.contains("Opera Mini") || userAgent.contains("Opera Mobi") || userAgent.contains("BlackBerry") || userAgent.contains("Android");
		try {
